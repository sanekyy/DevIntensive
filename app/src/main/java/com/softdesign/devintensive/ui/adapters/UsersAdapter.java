...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder> {
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public UserViewHolder(View itemView, CustomClickListener clickListener) {
            ...
            mRating = (TextView) itemView.findViewById(R.id.rating_tv);
            mCodeLines = (TextView) itemView.findViewById(R.id.code_lines_tv);
            mProjects = (TextView) itemView.findViewById(R.id.projects_tv);
            mBio = (TextView) itemView.findViewById(R.id.bio_tv);
